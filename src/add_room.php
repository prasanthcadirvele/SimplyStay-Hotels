...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $room = new Room($_POST['room_number'], $_POST['room_type'], $_POST['price_per_night'], $_POST['room_description'], $_POST['thumbnail_image']);
    $dbManagerDirecteur->insertRoom($room);
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                        ...
                        <div class="card">
                            ...
                            <form class="form-card" action="add_room.php" method="post">
                                    ...
                                    <div class="form-group col-sm-6 flex-column d-flex">
                                        ...
                                        <select class="form-control" name="room_type">
                                            <?php foreach ($room_types as $roomType): ?>
                                                <option value="<?php echo $roomType['room_type']; ?>"><?php echo $roomType['room_type']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                ...
                                <div class="row justify-content-between text-left">
                                    <div class="form-group col-sm-6 flex-column d-flex">
                                        ...
                                        <input type="number" id="price_per_night" name="price_per_night" placeholder="Price per Night" required>
                                    </div>
                                    <div class="form-group col-sm-6 flex-column d-flex">
                                        <label class="form-control-label px-3">Url Image Thumbnail<span class="text-danger"> *</span></label>
                                        <input type="text" id="thumbnail_image" name="thumbnail_image" required>
                                    </div>
                                </div>
                                <div class="row justify-content-between text-left">
                                    <div class="form-group col-sm-6 flex-column d-flex">
                                ...
                                <div class="row justify-content-end">
                                    <div class="form-group col-sm-2">
                                        <button type="submit" class="btn-block" style="background-color: #E3B04B; color: white">Add Room</button>
                                    </div>
                                </div>
                                <?php
